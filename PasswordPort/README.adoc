...
= Project: PasswordPort

This program shows how we can use a adrino device as password port.
...
....
 PasswordPort                 => Arduino sketch folder
  ├── PasswordPort.ino        => main Arduino file
