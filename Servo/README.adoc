...
= Project: Servo Motor uses in Arduino

This program is simple illustration of SG-90 survo motor.
...
....
 Servo                        => Arduino sketch folder
  ├── Servo.ino               => main Arduino file
